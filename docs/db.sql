...
CREATE TABLE wp_cospend_group_members (
    ...
    FOREIGN KEY (user_id) REFERENCES wp_cospend_users(id)
);
...
CREATE TABLE wp_cospend_expenses (
    ...
    FOREIGN KEY (group_id) REFERENCES wp_cospend_groups(id),
    FOREIGN KEY (payer_id) REFERENCES wp_cospend_users(id),
...
CREATE TABLE wp_cospend_transactions (
    ...
    FOREIGN KEY (from_user_id) REFERENCES wp_cospend_users(id),
    FOREIGN KEY (to_user_id) REFERENCES wp_cospend_users(id)
);
